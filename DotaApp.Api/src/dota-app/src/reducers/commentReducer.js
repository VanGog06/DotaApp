...
export const comments = (state = initialState, action) => {
  switch(action.type) {
    ...
    case adminConstants.COMMENTS_REVIEW_FAILURE:
      return { ...state, all: [ ...state.all ], reviewComments: [ ...state.reviewComments ] };
    case adminConstants.APPROVE_COMMENT_REQUEST:
      return { ...state, all: [ ...state.all ], reviewComments: [ ...state.reviewComments ] };
    case adminConstants.APPROVE_COMMENT_SUCCESS:
      return { ...state, all: [ ...state.all ], reviewComments: action.reviewComments };
    case adminConstants.APPROVE_COMMENT_FAILURE:
      return { ...state, all: [ ...state.all ], reviewComments: [ ...state.reviewComments ] };
    case adminConstants.REJECT_COMMENT_REQUEST:
      return { ...state, all: [ ...state.all ], reviewComments: [ ...state.reviewComments ] };
    case adminConstants.REJECT_COMMENT_SUCCESS:
      return { ...state, all: [ ...state.all ], reviewComments: action.reviewComments };
    case adminConstants.REJECT_COMMENT_FAILURE:
      return { ...state, all: [ ...state.all ], reviewComments: [ ...state.reviewComments ] };
    default:
